const database = {
    ptbr:{
        ...
        artigos:[
            {ampliandoVisao:`
                <h2>Ampliando a visão</h2>
                <h3>Alexandre Romanini, Altivo Duarte e Rodrigo Mitre</h3>
            ...
            {
                artPensamento:`
                <h2>Arte, pensamento em ato</h2>
                <h3>Libéria Neves e Vicente Camiloti<h3>
                <p>Entre 2015 e 2020 no Brasil, mudanças radicais no panorama político nacional afetaram diretamente o setor cultural, sobretudo o campo das artes. O status quo que se articulou foi responsável por alimentar censuras, difamar o fomento cultural subsidiado com apoio do Estado, e restringir o financiamento da produção artística às iniciativas privadas e colaborativas.</p>
            ...
            {
                apenasComeco:`
                <h2>Apenas o começo</h2>
                <h3>Raphael Fonseca</h3>
                <p>Ao observar os primeiros cinco anos da galeria Periscópio, chamam a atenção a presença dos diversos perfis de artistas, curadores e projetos expositivos desenvolvidos na primeira sede que abrigou a galeria. Diferentemente de tantos espaços comerciais dedicados às artes visuais que parecem enclausurados em um perfil muito sisudo de artistas, a Periscópio realizou experimentações a partir de desejos de difícil realização: esteve aberta a artistas residentes na cidade de Belo Horizonte, mas, ao mesmo tempo, não deixou de olhar para artistas de diferentes regiões do Brasil; dialogou com grandes referências da história da arte no país, ao passo que trouxe nomes que, em seu espaço, faziam suas primeiras individuais.</p>
