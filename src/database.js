const database = {
        ...
        index: {
            ...
            ensaios: {
                ...
                itens: [{
                    ...
                    <p>Muito antes, em meados da década de 1990, Rodrigo tinha escutado o artista Amilcar de Castro (1920-2002) falar sobre um sonho: criar uma galeria para expor jovens artistas, que funcionasse por meandros menos habituais. A palavra de ordem era esperança. Isso se tornou a inspiração para o seu projeto de graduação e foi o que lançou o primeiro grão que anos mais tarde daria em semeadura. Esse pensamento original atravessou diferentes fases até sua maturação, e foi a partir da troca entre nós três que ele ganhou o tônus final.</p> 
                    <p>O objetivo, por um lado, era energizar o circuito mineiro e nacional, oferecendo palco para as questões conceituais, procedimentais e políticas urgentes, de difícil vazão à época. Por outro, o propósito era experimentar novas maneiras de desenvolver diálogos e parcerias com os agentes da arte, e de ativar, receber e se relacionar com o público. Nesse caminho cada um trouxe suas vivências, conhecimentos técnicos e, sobretudo, vontade de fazer e ilimitada dedicação aos propósitos e ao projeto.</p> 
                    <p>Então, no fim de 2015, uma época em que o país já mergulhava num período conturbado e de profundas dificuldades, resolvemos abrir a galeria. Naquele contexto de retração econômica e enormes incertezas, estávamos cientes da complexidade do desafio, mas igualmente confiantes. Afinal, não havia um plano b: era este o projeto que nossas vidas e a cidade pediam, e estávamos dispostos a levá-lo às últimas circunstâncias.</p>  
                    <p>A nossa primeira sede foi uma casa tombada pelo Patrimônio Histórico Municipal de Belo Horizonte, localizada na avenida Álvares Cabral, no centro – lugar permeado por grandes instituições e recorte fundamental para a difusão cultural na cidade. Foi necessário reformar com muito esmero o imóvel, e o excesso de trabalho e a onerosidade por vezes tornaram-se um grande desafio. No entanto, a localização, a porosidade em relação ao público  e o charme do casarão sempre compensaram quaisquer obstáculos.</p>
                    <p>Entre 2015 e 2020, foram realizadas 28 mostras num espaço diferente do tradicional “cubo branco”. O que apresentaremos neste livro é um registro desses nossos anos iniciais. De modo arrojado e com o necessário atrevimento, muito pôde ser experimentado, apesar das extremas dificuldades. Olhando em retrospectiva para cada projeto expositivo, nota-se entre eles um fio condutor. É algo que não se consegue traduzir em palavras, mas sabemos que envolve a prática conduzida pelo olhar sensível e a força da criação dirigida para as emergências contemporâneas.</p> 
                    <p>Nesta revisão dos primeiros cinco anos de nossa história, há apenas uma certeza: não nos furtamos da batalha. Nós nos aproximamos de artistas e de outros pensadores nos quais acreditamos, e trouxemos à vida os projetos que julgamos necessários. Com a solidez, fruto  da experiência adquirida na metade da última década, e tomando fôlego para encarar novos ciclos, nosso desejo é seguir contribuindo para uma história da arte brasileira mais diversa e mais vibrante, capaz de ampliar a visão e a atuação humana. Capaz de nos fazer enxergar e ir além.</p>`
                },
                {
                    titulo: 'Programa para transver o mundo',
                    autoria: 'Germano Dushá',
                    texto: `<p>Quando, pela primeira vez, ouvi falar da galeria Periscópio — cujo nome insólito denota a intenção de seus fundadores de abrir mão da comum associação pessoal em prol de uma ideia —, fui tomado por um bom presságio. A galeria abriria dali a alguns meses, e o frescor de ter um novo espaço com uma disposição singular e um programa próprio capaz de energizar o sistema de arte de Belo Horizonte contou com meu entusiasmo de imediato. Somou-se a esse ânimo inicial o fato de o local escolhido para sua sede ser uma charmosa casa tombada, localizada num ponto importante da metrópole e, além disso, de estar na rua da casa dos meus pais – minha residência na cidade.</p>
                    <p>Por intermédio da amiga querida e parceira constante Lais Myrrha, logo tive o prazer de conhecer seus idealizadores: Rodrigo, Altivo e Alexandre. A empatia ocorreu prontamente, de modo que todos os pontos confluíram para encontrar ali uma situação de abertura energética e, mais tarde, um terreno familiar e fértil para o trabalho.</p>
                    <p>Decidimos então unir esforços na exposição que inauguraria sua chegada ao mundo – "Domingo", mostra individual de Fábio Tremonte. Desse ponto em diante, praticamente todos os anos realizamos juntos algum projeto oficialmente e, de forma indireta, seguimos em uma troca ininterrupta. Assim, gosto de pensar que colaborei para dar início e pavimentar o caminho da galeria, da mesma maneira que ela marcou a minha trajetória, tecendo uma trama rara entre o rigor profissional e os melhores afetos.</p>
                    <p>Organizar este livro foi uma maneira de visitar memórias importantes colhidas ao longo daqueles cinco anos, revendo imagens que trouxeram brilho aos olhos que testemunharam uma empreitada autêntica, inovando em meio às dificuldades inerentes de um circuito rarefeito. No entanto, foi sobretudo uma oportunidade de descobrir novas conexões no interior de uma programação intensa e complexa, articulando suas diversas proposições.</p>
                    <p>No conjunto formado pelas quase três dezenas de exposições realizadas em sua primeira sede é evidente a construção de um lugar próprio para o livre desenvolvimento da linguagem. No que pesem as diferenças de cada um dos projetos – que não se submetem às etiquetas redutoras –, é possível enxergar a aproximação de um mesmo ânimo compartilhado, uma mesma verve da invenção. Dos muitos jovens artistas àqueles de ampla trajetória que demandam devida atenção e reverência, dos discursos diretos aos jogos semânticos, das ações de transformação do espaço às experimentações pictóricas: é patente o movimento, o calor e a ocasião de criações conscientes da urgência que nos cercam e que estão engajadas em reelaborar a nossa realidade.</p> 
                    <p>Aos que participaram direta ou indiretamente dessa história, este livro nos serve como uma saudação, um brinde;  aos que se interessam pelos meandros da produção cultural e pelas possibilidades do pensamento contemporâneo no Brasil, aqui se encontra uma oportunidade para conhecer o trabalho de dezenas de artistas e agentes da arte de diferentes lugares, que, com sua diversidade de épocas, trajetórias, identidades, pesquisas e práticas, semeiam pela superfície obras potentes, orientadas por inúmeros interesses e servindo-se de inúmeros meios e formas.</p>
                    <p>Portanto, o nome da galeria ter tomado de empréstimo a designação do instrumento que permite enxergar por cima de obstáculos se justifica. Seu programa tem como objetivo contribuir para que o corpo submerso eleve a visão, enxergando além das barreiras cotidianas e, consequentemente, fertilizando seu campo de imaginação. Parece  seguir à risca a orientação universal do poeta Manoel de Barros: “É preciso transver o mundo”.</p> 
    `
                },
                {
                    titulo: 'Arte – pensamento em ato',
                    autoria: 'Libéria Neves e Vicente Camiloti',
                    texto: `<p>Entre 2015 e 2020 no Brasil, mudanças radicais no panorama político nacional afetaram diretamente o setor cultural, sobretudo o campo das artes. O status quo que se articulou foi responsável por alimentar censuras, difamar o fomento cultural subsidiado com apoio do Estado, e restringir o financiamento da produção artística às iniciativas privadas e colaborativas.</p>
                    <p>A galeria Periscópio nasceu nesse cenário, emergindo em meio à turbulência e motivada por uma escolha: não recuar diante do obscurantismo. Isso se viu atrelado às outras visões que moveram seus idealizadores a transpor a ideia canônica de galeria e constituir-se na intersecção entre artistas emergentes buscando um espaço de germinação; artistas consagrados à procura de um espaço de resistência; e o público – tão diverso e múltiplo – que demanda, em comum, um espaço de cultura afeito ao pensamento estético, capaz de significar e prever o mundo por meio da arte contemporânea.</p>
                    <p>Assim, exposições, performances, eventos filosóficos, educativos, em colaboração com iniciativas similares que transbordaram a cidade de Belo Horizonte (como a criação da plataforma de Colaboração entre Agentes do Mercado de Artes, ou CAMA, em São Paulo), fizeram daquela casa – potente e aconchegante – um centro de constante atividade.</p>
                    <p>Esqueça o futuro, obra de Rafael RG, nos pareceu um lema, por não esperar acontecer, e sim, tornar-se o acontecimento. Uma placa instalada no canteiro central da avenida que liga a praça Afonso Arinos à praça da Assembleia levou uma provocação aos transeuntes e mobilizou a imprensa mediante o questionamento em torno da legalidade e do significado do ato que atropelou o sentido de placa de trânsito – que orienta, normatiza, regra –, reavivando a desregulamentação que comporta a arte contemporânea.</p> 
                    <p>Com um olhar que se direciona para além das nuvens e das montanhas, a Periscópio configurou-se como uma resposta estética e política ao projeto de “pretérito do futuro” paralisante, imposto nesses cinco anos. Praticando pensamento em ato; em arte!</p>
    `
                },
                {
                    titulo: 'Apenas o começo',
                    autoria: 'Raphael Fonseca',
                    texto: `<p>Ao observar os primeiros cinco anos da galeria Periscópio, chamam a atenção a presença dos diversos perfis de artistas, curadores e projetos expositivos desenvolvidos na primeira sede que abrigou a galeria. Diferentemente de tantos espaços comerciais dedicados às artes visuais que parecem enclausurados em um perfil muito sisudo de artistas, a Periscópio realizou experimentações a partir de desejos de difícil realização: esteve aberta a artistas residentes na cidade de Belo Horizonte, mas, ao mesmo tempo, não deixou de olhar para artistas de diferentes regiões do Brasil; dialogou com grandes referências da história da arte no país, ao passo que trouxe nomes que, em seu espaço, faziam suas primeiras individuais.</p>
                    <p>Basta percorrer os nomes dos artistas que realizaram exposições individuais nos primeiros doze meses da Periscópio para notar essa encruzilhada. Para sua inauguração, a galeria realizou duas exposições individuais: de Marc Davi, artista que reside em Beagá, e outra de Fábio Tremonte, que vive em São Paulo. Para o segundo projeto, uma coletiva com Andréa Brown (Rio de Janeiro), Márcio Diegues (São Paulo) e Camila Lacerda, também da capital mineira. Posteriormente, duas exposições individuais traziam artistas da região Norte do Brasil: Éder Oliveira (Belém do Pará) e Marcone Moreira (Maranhão). No final de 2016, foi a vez de Marcelo Drummond, referência para o campo das artes visuais em Beagá e, por fim, uma exposição retrospectiva de Ivens Machado (Santa Catarina) em diálogo com outros artistas.</p>
                    <p>Tamanha programação proposta já no seu primeiro ano de galeria era apenas sintoma daquilo que estava por vir e que se solidificou nessa meia década de atuação. No momento em que escrevo este texto, o compromisso da Periscópio em desdobrar camadas de sentido e conexão se vê claramente refletida na exposição “corpocontinente”, com curadoria de Fabíola Rodrigues. Dedicado à investigação dos “intercâmbios entre as culturas dos povos originários do Brasil e das populações trazidas da África”, o projeto reúne artistas de recente reconhecimento institucional no Brasil para construir um diálogo poderoso. Essa exposição parece ser exemplar da caminhada, da atenção e das mudanças – sutis, mas firmes – sugeridas pela Periscópio em seu pouco tempo de vida.</p>
                    <p>Rafael RG, Randolpho Lamonier, Ana Linnemann, Gisele Camargo, Umberto Costa Barros, Luana Vitra, Selma Parreira, Flávio Cerqueira, os curadores Germano Dushá, Marina Câmara... são apenas algumas das pessoas que por aqui passaram e que possibilitaram os objetivos ousados da Periscópio, materializando seu programa em casa e em itinerâncias e trazendo ao público de Beagá (e além) a fruição da produção de artes visuais no Brasil de forma política, provocativa  e por vezes trans-histórica e plurigeográfica.</p>
                    <p>E isso é apenas o começo.</p>`
                }],
            },
            exposicoes: {
                titulo: 'Exposições',
        ...
        popups: {
            audioDescricao: 'CLIQUE NO LINK ABAIXO PARA FAZER O DOWNLOAD DO ARQUIVO DE ÁUDIO COM A DESCRIÇÃO E LEITURA DO LIVRO',
            download: 'CLIQUE NO LINK ABAIXO PARA FAZER O DOWNLOAD DA PUBLICAÇÃO NA ÍNTEGRA. ',
        },
    ...
    en: {
        ...
        popups: {
            audioDescricao: 'CLICK ON THE LINK BELOW TO DOWNLOAD THE AUDIO FILE WITH THE DESCRIPTION AND A READING OF THE BOOK.',
            download: 'CLICK ON THE LINK BELOW TO DOWNLOAD THE FULL PUBLICATION.',
        },
    }
